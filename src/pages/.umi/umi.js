...
import findRoute, {
  getUrlQuery,
} from '/Users/wb-zhangyuying.c/Desktop/alibaba/own/umiDvaAntd/node_modules/_umi-build-dev@1.16.7@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/_umi-plugin-ui@1.4.7@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: '/Users/wb-zhangyuying.c/Desktop/alibaba/own/umiDvaAntd',
        currentProject: '',
        isBigfish: undefined,
      },
    );
